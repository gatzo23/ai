...
class Model:
    def __init__(self):
        ...
        self.optimizer = tf.optimizers.SGD(learning_rate=self.learning_rate) # stochastic gradient descent
    ...
    def fit(self):
        self.optimizer.minimize(self.loss, self.x) #loss function, variablen
...
for it in range(5000):
    model.fit()
    if it % 100 == 0:
        print(model.x.numpy(), model.current_loss_val)
